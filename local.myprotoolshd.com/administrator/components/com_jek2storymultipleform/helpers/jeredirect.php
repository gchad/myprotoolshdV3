...
class JFormFieldjeredirect extends JFormFieldList
{
	protected $type 	= 'jeredirect';
	...
	function getInput()
	{
		...
		/*$sel_pcat[0]->text	= JText::_('SELECT_RIDRECTPAGE');	
		$sel_pcat[0]->value	= '0';*/
		$sel_pcat[]  = JHTML::_('select.option', '0 ', JText::_( 'SELECT_RIDRECTPAGE'));
