...
class plgSystemSh404sef extends JPlugin
{
	...
	public function onAfterInitialise()
	{
		...
		if (Sh404sefFactory::getConfig()->Enabled && $app->isSite())
		{
			$this->_hacks();
		}
	...
	protected function _hacks()
	{
		...
		{
			if ($format == 'html' && $this->_shouldForceLanguage($app))
			{
	...
	protected function _shouldForceLanguage($app)
	{
		...
		if (Sh404sefHelperLanguage::getInsertLangCodeInDefaultLanguage())
		{
			return false;
		}
