            ...
            foreach ($vars as $field => $value) {
                ...
                if(preg_match($exPattern, $field, $matches) && $filter != $field && $field == 'xf_8') {
                    ...
                    $matrix = array(
                        ...
                        //Middle East
                        9 => array(17,59,69,108,109,112,118,123,127,176,180,192,207,229,241,251,263),
                        
                        //Europe
                        10 => array(2,5,11,14,15,20,21,27,35,57,59,60,62,73,78,79,86,87,90,104,105,110,113,119,122,126,131,132133,135,141,151,152,154,162,175,189,190,193,194,205,209,214,215,221,227,228,241,249,252,257),
