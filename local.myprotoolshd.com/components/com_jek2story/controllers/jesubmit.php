...
{ 
	...
	//============================================================End of extra field code ====================================================================			
			//$sql="UPDATE #__k2_items SET `title`='".$post['title']."',`catid`=".$post['catid'].",`introtext`='".$fulltext."',`fulltext`='".$fulltext."',`extra_fields`='".$field_data."', `extra_fields_search` ='".$field_search."' WHERE id=".$post['k2itemid']; 
