	...
	<?php }?>
		<tr>
			<td>	
				...
				<input type="submit" name="save" onSubmit="return submitbutton()" class="button"  value="<?php echo  JText::_( 'SUBMIT_BUTTON'); ?>"  />			<input type="button" name="cancel" onClick="history.go(-1)" class="button"  value="<?php echo  JText::_( 'CANCEL_BUTTON'); ?>"  /><br /><br />
			</td>
		</tr>
	</table>
