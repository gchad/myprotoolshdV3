...
<div class="login-wrap2">
  ...
  <form action="<?php echo $link;?>" method="post" name="myadminform" enctype="multipart/form-data" onSubmit="return submitbutton()" >
	...
	<tr>
	 	...
	 	<tr> 
			<td><input class="inputbox"  type="text" name="name" size="50" maxlength="100" value="<?php if($ses==1) { echo $_SESSION['name']; } if($id){ echo $this->detail->name;} ?>" />
		    <br /></td>
		</tr>
	<?php }?>	
	<?php if($setting->email == 1){?>		
	 	...
	 	<tr> 
			<td><input class="inputbox" type="text" name="email" size="50" maxlength="100" value="<?php if($ses==1) { echo $_SESSION['email']; } if($id){ echo $this->detail->email;} ?>" />
		    <br /></td>
		</tr>	
	<?php }
	...
	?>
	 	...
	 	<tr> 
			<td><input class="inputbox" type="text" name="title" size="50" maxlength="100" value="<?php if($ses==1) { echo $_SESSION['title']; } if($id){echo $this->detail->title;} ?>" />
		    <br /></td>
		</tr>
<?php 		
...
{?>
		<tr>
 			<th align="left"> <?php echo JText::_( 'CATEGORY'); ?> : <br /></th>
		</tr>
		<tr>
			<td><?php echo $this->lists['catid']; ?><br /></td>
		</tr>
 <?php }else {?>
 ...
 <?php } ?><br />
		<tr><td> <div id="extrafield_data" style="display:none;">
	 	...
	 	<tr>
	 		<th align="left"><?php echo  JText::_( 'MAINTEXT'); ?><br /></th>
		</tr>
  		<tr>
			<td><?php
			if($id)
		...
		<tr>
		<th align="left"><?php echo  JText::_( 'UPLOAD_IMAGE'); ?><br /></th>
		</tr>
		<tr>
		<td>
		...
		<tr>
			<td><input class="inputbox" type="text" name="cap" value="" id="cap" />
		    <br /></td>
	...
	<?php }?>
		<tr>
			<td>	
				...
				<input type="submit" name="save" onSubmit="return submitbutton()" class="button2"  value="<?php echo  JText::_( 'SUBMIT_BUTTON'); ?>"  />			<input type="button" name="cancel" onClick="history.go(-1)" class="button2"  value="<?php echo  JText::_( 'CANCEL_BUTTON'); ?>"  /><br /><br />
			</td>
		</tr>
	</table>
