...
function select_cate(did)
{
	...
	var url = mylive_url+"index.php?tmpl=component&option=com_jek2storymultipleform&view=jesubmit&task=getExtrafield&did=" + did + "&itemid="+itemid;
...
function cap_refresh()
{
	...
	var url = mylive_url+"index.php?option=com_jek2storymultipleform&view=jesubmit&task=refresh_captchacr&tmpl=component";
	xmlHttp.open("GET", url, true)
	xmlHttp.send(null);			
}
...
function get_item(cid)
{
	...
	var url = jelurl+"index.php?tmpl=component&option=com_jek2storymultipleform&view=itemlist&task=getitem&k2category="+cid+"&item_id1="+ajax_item_id;
