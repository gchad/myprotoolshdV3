...
class modPwebcontactHelper
{
	...
	public static function initHeader() 
	{
		...
		if ($params->get('show_upload', 0)) 
		{
			...
			if ($params->get('load_jquery_fileupload', 1)) {
				...
				if ($debug) {
					...
					$doc->addScript($media_url.'js/jquery.fileupload.min.js?v=5.41.0');
				}
			}
		...
		if ($params->get('load_jquery_validate', 1)) 
			$doc->addScript($media_url.'js/jquery.validate'.($debug ? '' : '.min').'.js?v=1.13.0');
		
		//TODO chosen
		//JHtml::_('script', 'jui/chosen.jquery.min.js', false, true, false, false, $debug);
		//JHtml::_('stylesheet', 'jui/chosen.css', false, true);

		$doc->addScript($media_url.'js/jquery.pwebcontact'.(file_exists($params->get('media_path').'js/jquery.pwebcontact.js') ? '' : '.min').'.js?v=3.2.14');
