...
jQuery(document).ready(function(){	
	jQuery('#jform_params_marker_icon').change(function(){
		if(jQuery(this).val() == 'ad_category')
		{
	...
	jQuery('select','.adsManagerCategoryMarkers').change(function(){
		buildAdsManagerCategoryMarkerJson();
	});
	
});
function buildAdsManagerCategoryMarkerJson()
{
	var jsonItems = [];
	jQuery('select','.adsManagerCategoryMarkers').each(function(){
