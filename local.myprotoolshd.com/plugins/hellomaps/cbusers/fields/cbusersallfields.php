 ...
 */
if(!class_exists('Cbusersallfields'))
{	
	class JFormFieldCbusersallfields extends JFormFieldList
	{
		/**
		 * The field type.
		 *
		 * @var		string
		 */
		protected $type = 'Cbusersallfields';
		...
		protected function getOptions() 
		{
			...
			if ($items)
			{			
				$options[] = JHtml::_('select.option', 'username', JText::_('PLG_HELLOMAPS_CBUSERS_USERNAME'));//put the username field
                $options[] = JHtml::_('select.option', 'email', JText::_('PLG_HELLOMAPS_CBUSERS_EMAIL'));//put the username field
