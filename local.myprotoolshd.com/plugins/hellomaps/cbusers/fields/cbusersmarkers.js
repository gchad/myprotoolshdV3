...
jQuery(document).ready(function(){	
	jQuery('#jform_params_marker_icon').change(function(){
		if(jQuery(this).val() == 'cbusersprofile-type')
		{
	...
	jQuery('select','.cbusersmarkers').change(function(){
		buildCbUsersProfileTypeMarkerJson();
	});
	
});
function buildCbUsersProfileTypeMarkerJson()
{
	var jsonItems = [];
	jQuery('select','.cbusersmarkers').each(function(){
