 ...
 */
if(!class_exists('JFormFieldCbUsersmarkers'))
{	
	class JFormFieldCbUsersmarkers extends JFormField
	{
		/**
		 * The field type.
		 *
		...
		{		
			...
			$document->addScript(JURI::root().'plugins/hellomaps/cbusers/fields/cbusersmarkers.js');
			...
			$fileOptions = array();
			$markersFolder = JPATH_ROOT.'/plugins/hellomaps/cbusers/images/markers';
			...
			$profileTypesHTML = '<ul class="cbusersmarkers" style="list-style:none;">';
			...
			return $profileTypesHTML.'<input type="hidden" name="' . $this->name . '" id="' . $this->id . '" value="'
                ...
                return 'Community Builder is not installed';
            }
