...
jQuery(document).ready(function(){	
	jQuery('#jform_params_marker_icon').change(function(){
		if(jQuery(this).val() == 'jeventsprofile-type')
		{
	...
	jQuery('select','.jeventsmarkers').change(function(){
		buildJeventsProfileTypeMarkerJson();
	});
	
});
function buildJeventsProfileTypeMarkerJson()
{
	var jsonItems = [];
	jQuery('select','.jeventsmarkers').each(function(){
