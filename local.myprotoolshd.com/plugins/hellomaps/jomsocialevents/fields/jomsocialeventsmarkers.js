...
jQuery(document).ready(function(){	
	jQuery('#jform_params_marker_icon').change(function(){
		if(jQuery(this).val() == 'jomsocialeventsprofile-type')
		{
	...
	jQuery('select','.jomsocialeventsmarkers').change(function(){
		buildJomsocialEventsProfileTypeMarkerJson();
	});
	
});
function buildJomsocialEventsProfileTypeMarkerJson()
{
	var jsonItems = [];
	jQuery('select','.jomsocialeventsmarkers').each(function(){
