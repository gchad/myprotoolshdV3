...
<div class="joms-landing <?php if (!$settings['general']['enable-frontpage-image']) echo "no-image"; ?>">
    ...
    <div class="joms-landing__action">
        <form class="joms-form" action="<?php echo CRoute::getURI(); ?>" method="post" name="login" id="form-login">
            <div class="joms-input--append">
                <svg viewBox="0 0 16 16" class="joms-icon">
                    <use xlink:href="<?php echo CRoute::getURI(); ?>#joms-icon-user"></use>
                </svg>
                <input class="joms-input" type="text" placeholder="<?php echo JText::_('JGLOBAL_EMAIL'); ?>"
            ...
            <button class="joms-button--login"
                    onclick="location.href='<?php echo CRoute::_('index.php?option=com_community&view=register', false); ?>'"><?php echo JText::_('COM_COMMUNITY_LOGIN') ?></button>
