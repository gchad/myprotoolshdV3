...
<?php }   ?>
        <p class="width30 floatleft" id="com-form-login-username">
            <input type="text" name="username" class="inputbox" size="18" alt="<?php echo vmText::_('JGLOBAL_EMAIL'); ?>" value="<?php echo vmText::_('JGLOBAL_EMAIL'); ?>" onblur="if(this.value=='') this.value='<?php echo addslashes(vmText::_('JGLOBAL_EMAIL')); ?>';" onfocus="if(this.value=='<?php echo addslashes(vmText::_('JGLOBAL_EMAIL')); ?>') this.value='';" />
	</p>
