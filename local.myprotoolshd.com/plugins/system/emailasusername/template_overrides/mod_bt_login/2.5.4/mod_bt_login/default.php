		...
		<div id="btl-content-registration" class="btl-content-block">			
			...
			<?php if($integrated_com==''){?>	
				...
				<form name="btl-formregistration" class="btl-formregistration"  autocomplete="off">
					...
					<input type="hidden" name="jform[username]" value="<?php echo substr(str_shuffle("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, 15);?>" id="btl-input-username1" />
			</form>
