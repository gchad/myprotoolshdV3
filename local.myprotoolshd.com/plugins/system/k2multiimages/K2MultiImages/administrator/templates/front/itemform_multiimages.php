...
<form action="index.php" enctype="multipart/form-data" method="post" name="adminForm" id="adminForm">
	...
	<div id="k2FrontendContainer">
		<div id="k2Frontend">
			<!--<table class="k2FrontendToolbar" cellpadding="2" cellspacing="4">
				<tr>
					<td id="toolbar-save" class="button">
						<a class="button2" href="#" onclick="javascript: submitbutton('save'); return false;"> <span title="<?php echo JText::_('K2_SAVE'); ?>" class="icon-32-save"></span> <?php echo JText::_('K2_SAVE'); ?> </a>
					</td>
					<td id="toolbar-cancel" class="button">
						<a class="button2" href="#"> <span title="<?php echo JText::_('K2_CANCEL'); ?>" class="icon-32-cancel"></span> <?php echo JText::_('K2_CLOSE'); ?> </a>
					</td>
				</tr>
			</table>-->
			...
			<?php endif; ?>
			<?php endif; ?>
			<?php /* <div id="k2ToggleSidebarContainer"> <a href="#" id="k2ToggleSidebar"><?php echo JText::_('K2_TOGGLE_SIDEBAR'); ?></a> </div>*/?>
                                                ...
                                                <?php foreach($this->extraFields as $extraField): ?>
                                                    ...
                                                    <tr >
                                                        <td align="right" class="key">
                                                            <label for="K2ExtraField_<?php echo $extraField->id; ?>"><?= JText::_('EDIT_'.( strtoupper ( str_replace (array('(',')','"','\''), '_',$extraField->name)))); ?></label>
                                                        </td>
						...
						<!--- added K2MultiImages --->
							<!--- item image --->								
								...
								<div class="simpleTabsContent" id="k2Tab2">
										...
										<table class="admintable image1">
											<tr>
												...
												<td>
													...
													<br />
													<br />
													<?php /* <input type="text" name="existingImage1" class="text_area" id="existingImageValue1" readonly />
									...
									<?php else: ?>
										<a href="#" class="AddNewImage button2" style="margin-top: 10px;"><?php echo JText::_('PLG_K2_MULTIIMAGES_IMAGE_NEW'); ?></a>
										<?php if(!$this->mainframe->isSite()) : ?>
