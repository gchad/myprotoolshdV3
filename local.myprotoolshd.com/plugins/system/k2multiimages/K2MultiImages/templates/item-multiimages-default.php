  ...
  <div class="itemBody">
	...
	<div class="itemImageContainer">
		...
		<?php if($filecount > 1 && $bcount != 1) {
			echo "<div class=\"itemImageBlock-container\" style=\"text-align: center;\">";
			$bcount = 1;
			}
		?>
		  <div class="itemImageBlock" <?php if($filecount > 1) : ?>style="display: inline-block;"<?php endif; ?>>
			  <span class="itemImage">
				<a class="modal" rel="{handler: 'image'}" href="<?php echo $this->item->$xlarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
					<?php if($filecount == 1) : ?>
