...
$loadParamsGridContents = JasonHelper::loadParamsGridContents($this->item);
...
<?php endif; ?>
	...
	<article>
		...
		<?php if ($params->get('show_title') || ($topInfo || $icons) || $botInfo || ($params->get('show_tags', 1) && !empty($this->item->tags)) || ($params->get('show_readmore') && $this->item->readmore) ) : ?>
