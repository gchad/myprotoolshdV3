...
<div class="system-unpublished">
	...
	<article>
      ...
      <?php echo JLayoutHelper::render('joomla.content.intro_image', array('images'=>$this->item->images, 'params'=>$this->item->params, 'url'=>$link)); ?>
		...
		<?php if ($params->get('show_intro') || $params->get('show_title') || ($topInfo || $icons) || $botInfo || ($params->get('show_tags', 1) && !empty($this->item->tags)) || ($params->get('show_readmore') && $this->item->readmore) ) : ?>
