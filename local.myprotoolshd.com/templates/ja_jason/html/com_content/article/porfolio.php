...
$extrafields = JasonHelper::loadParamsPortfolioContents($this->item);
$extrafieldsexist = ($extrafields['jcontent_type'] != '') || ($extrafields['jcontent_updateon'] != '') || ($extrafields['jcontent_version'] != '') || ($extrafields['jcontent_author'] != '');
...
<div class="porfolio-detail item-page<?php echo $this->pageclass_sfx ?> clearfix">
...
<aside class="article-aside clearfix">
  <?php if ($topInfo): ?>
  <?php echo JLayoutHelper::render('joomla.content.info_block.block_portfolio', array('item' => $this->item, 'params' => $params, 'position' => 'above')); ?>
  <?php endif; ?>
		...
		<div class="portfolio-default">
          ...
          <ul class="extrafield-list">
            ...
            <?php if ($params->get('show_category')) : ?>
                <?php echo JLayoutHelper::render('joomla.content.info_block.category_portfolio', array('item' => $this->item, 'params' => $params)); ?>
            <?php endif; ?>
          </ul>
          <?php endif; ?>
