...
if (empty ($this->element)) {
	...
	<?php
		if(!empty($this->links->previous))
			echo "<a class='hikashop_previous_product' title='".JText :: _('PREVIOUS_PRODUCT')."' href='".$this->links->previous."'><span>". JText :: _('PREVIOUS_PRODUCT') ."</span></a>";
		if(!empty($this->links->next))
			echo "<a class='hikashop_next_product' title='".JText :: _('NEXT_PRODUCT')."' href='".$this->links->next."'><span>".JText :: _('NEXT_PRODUCT')."</span></a>";
