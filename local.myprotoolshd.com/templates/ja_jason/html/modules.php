...
{ 
	...
	if (!empty ($module->content)) {
		$html = "<{$moduleTag} class=\"t3-module {$moduleClassSfx} {$moduleClass}\" id=\"Mod{$module->id}\"><div class=\"container\"><div class=\"row\">". $badge;

		if ($module->showtitle != 0) {
		$html .= "<{$headerTag} class=\"row-title col-md-3 {$headerClass}\">";
		...
		$html .= "<div class=\"row-ct {$rowctcol}\">{$module->content}</div></div></div></{$moduleTag}>";
