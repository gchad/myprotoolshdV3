...
<?php if(HIKASHOP_RESPONSIVE){ ?>
	<div class="row">
<?php } ?>
<div id="hikashop_product_left_part" class="hikashop_product_left_part col-md-8">
	<?php
...
<div id="hikashop_product_right_part" class="hikashop_product_right_part col-md-4">
	<?php
	if(!empty($this->element->extraData->rightBegin))
		echo implode("\r\n",$this->element->extraData->rightBegin);
	?>
	<div id="hikashop_product_vote_mini" class="hikashop_product_vote_mini">
		<span class=""><?php echo JText::_('TPL_VOTING_LABEL'); ?></span>
		<?php
	...
	<span id="hikashop_product_price_main" class="hikashop_product_price_main">
		<span class=""><?php echo JText::_('TPL_PRICING_LABEL'); ?></span>
		<?php
