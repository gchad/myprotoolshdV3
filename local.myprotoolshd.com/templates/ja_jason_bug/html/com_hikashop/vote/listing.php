...
if ($comment_enabled == 1) {
	...
	if (($hikashop_vote_con_req_list == 1 && $hikashop_vote_user_id != "") || $hikashop_vote_con_req_list == 0) {
		...
		?>
				<li class="ui-corner-all hika_comment_listing row">
					<div class="hika_comment_listing_top clearfix col-md-2 col-sm-12">
						...
						?>
								<?php if($useful_style == "thumbs"){?>
									<div class="hika_comment_listing_useful_p ui-corner-all">
						...
						?>
									...
									<div class="hika_comment_listing_useless_p ui-corner-all">
										<?php echo $hika_useless[$i];?>
									</div>
						...
						<div id="<?php echo $i; ?>" class="hika_comment_listing_content col-md-10 col-sm-12"><?php echo $elt[$i]->vote_comment; ?></div>
		...
		if($no_comment == 1){
			?>
			<ul>
				<li class="hika_comment_listing last">
