...
<div class="catItem-listing catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
			...
			<?php endif; ?>
		  	...
		  	<?php if($this->item->params->get('catItemDateCreated')): ?>
				...
				<span class="catItemDateCreated">
					<i class="fa fa-calendar"></i> <?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_LC')); ?>
				</span>
				<?php endif; ?>
