...
// Header Params
$headervideo  = $this->params->get('headervideo','');
$headerimage  = $this->params->get('headerimage','');
$headertype   = $this->params->get('headertype', 'image');

if ($headerimage && ($headertype == 'image')):

$style = 'style="background-image: url('.$headerimage.')"';

endif;
?>

<!-- HEADER -->
<header id="t3-header" class="wrap t3-header t3-header-1 <?php if($headerimage || $headervideo): echo 't3-header-mask'; endif; ?> <?php if($headervideo && ($headertype == 'video')): echo 't3-header-video'; endif; ?>" <?php if($headerimage && ($headertype == 'image')): echo $style; endif; ?> >
	
	<?php if($headervideo && ($headertype == 'video')): ?>
		<iframe frameborder="0" width="100%" height="100%" allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" src="//player.vimeo.com/video/94101559?title=0&amp;byline=0&amp;portrait=0&amp;autoplay=1&amp;loop=1"></iframe>
	<?php endif; ?>
