...
<!-- HEADER -->
<header id="t3-header" class="wrap t3-header t3-header-3 <?php if($headerimage || $headervideo): echo 't3-header-mask'; endif; ?> <?php if($headervideo && ($headertype == 'video')): echo 't3-header-video'; endif; ?>" <?php if($headerimage && ($headertype == 'image')): echo $style; endif; ?> >
